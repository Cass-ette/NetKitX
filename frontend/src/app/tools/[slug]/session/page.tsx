...
/**
 * Render a session-based UI for a tool plugin identified by slug.
 *
 * Displays tool metadata, a parameter form for session-relevant inputs, and an interactive terminal when a session is active.
 * Manages creating and terminating plugin sessions and attempts cleanup of any active session on page unload.
 *
 * @param params - A promise that resolves to an object containing the route `slug` for the tool
 * @returns The page's React element containing the connection form, loading/error states, and the session terminal view
 */
